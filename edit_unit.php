...
if (isset($_POST['edit_btn'])) {
    ...
    <h6 class="m-0 font-weight-bold" style="color: white;">Edit Unit</h6>
</div>
                <div class="card-body">
                ...
                <input type="text" name="edit_unit" value="<?php echo $row['unit_name'] ?>" class="form-control" placeholder="Input Unit" required />
            </div>
            <div class="modal-footer" style="background-color: #ffff; border-top: 1px solid #ccc;">
    <a href="add_unit.php" class="btn btn-danger" style="border-radius: 5px; padding: 10px 20px; background-color: #EB3223; border: none; margin-top: 8px; margin-bottom: -15px;">Cancel</a>
    <button type="submit" name="updateunitbtn" class="btn btn-primary modal-btn" style="border-radius: 5px; padding: 10px 20px; background-color: #259E9E; border: none; margin-top: 8px; margin-bottom: -15px;">Update</button>
</div>

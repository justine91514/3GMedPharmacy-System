...
?>
    ...
    <h6 class="m-0 font-weight-bold" style="color: white;">Edit Type</h6>
</div>
        <div class="card-body">
            <?php
            ...
            if (isset($_POST['edit_btn'])) {
                ...
                <input type="text" name="edit_type" value="<?php echo $row['type_name'] ?>" class="form-control" placeholder="Input Type" required />
            </div>
                    <div class="modal-footer" style="background-color: #ffff; border-top: 1px solid #ccc;">
    <a href="add_product_type.php" class="btn btn-danger" style="border-radius: 5px; padding: 10px 20px; background-color: #EB3223; border: none; margin-top: 8px; margin-bottom: -15px;">Cancel</a>
    <button type="submit" name="update_type_btn" class="btn btn-primary modal-btn" style="border-radius: 5px; padding: 10px 20px; background-color: #259E9E; border: none; margin-top: 8px; margin-bottom: -15px;">Update</button>
                    </form>
                    <?php
                }
            }

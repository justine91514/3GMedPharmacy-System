                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            <label style="color: #259E9E;">Category Name</label>
                            <input type="text" name="category_name" class="form-control modal-input"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary modal-btn" name="categorybtn"
                ...
                <h6 class="m-0 font-weight-bold text-primary">
                    <button type="button" class="btn btn-primary rounded-pill shadow mb-3" data-toggle="modal"
                        ...
                        <i class="fas fa-plus-square fa-lg"></i> <span
                            style="font-weight: bold; text-transform: uppercase;">Add New Category</span>
                    </button>
                </h6>

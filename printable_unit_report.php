...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 90, 'Unit Report', 0, false, 'C', 0, '', 0, false, 'T', 'M');
...
$query = "SELECT * FROM unit_list ORDER BY id DESC";
$result = mysqli_query($connection, $query);

// Add a page
$pdf->AddPage();

// Define the widths for each column based on the maximum content width
$maxWidth = array(20, 70); // Default widths for ID and Unit Name
...
$pdf->Cell($maxWidth[1], 10, 'Unit Name', 1, 1, 'C', 1);
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $pdf->Cell($maxWidth[1], 10, $row['unit_name'], 1, 1, 'C');
    $pdf->SetX($headerXPos);
}

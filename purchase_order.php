...
<div class="modal fade" id="addadminprofile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="handle_purchase_order.php" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="modal-label" style="color: #259E9E;">Supplier</label>
                    ...
                    <div class="form-group">
                        <label style="color: #259E9E;">Product</label>
                    ...
                    <div class="form-group">
                        <label style="color: #259E9E;">Branch</label>
                        <select name="branch" class="form-control" required
                            style="border-radius: 5px; border: 1px solid #ccc; padding: 6px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                            <option value="" disabled selected>Select Branch</option>
                            <option value="Cell Med" <?php echo ($selectedBranch === 'Cell Med') ? 'selected' : ''; ?>>
                                Cell Med</option>
                            <option value="3G Med" <?php echo ($selectedBranch === '3G Med') ? 'selected' : ''; ?>>3G
                                Med</option>
                            <option value="Boom Care" <?php echo ($selectedBranch === 'Boom Care') ? 'selected' : ''; ?>>
                                Boom Care</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label style="color: #259E9E;">Quantity:</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary modal-btn" name="supplierbtn"
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm" action="code.php" method="POST">
                    ...
                    <button type="submit" name="delete_sup_btn" class="btn btn-danger"
            ...
            <h6 class="m-0 font-weight-bold text-primary">
                <button type="button" class="btn btn-primary rounded-pill shadow mb-3" data-toggle="modal"
                    ...
                    <i class="fas fa-plus-square fa-lg"></i> <span
                        style="font-weight: bold; text-transform: uppercase;">Add New Order</span>
                </button>
            </h6>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;">
                                        <button class="btn btn-action" style="border: none; background: none;"
                                            data-toggle="modal" data-target="#receiveModal" data-id="<?php echo $row['id']; ?>">
                                            <i class="fas fa-receipt" style="color: #808080;"></i>
                                        </button>

                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            <label style="color: #259E9E;">Type Name</label>
                            <input type="text" name="type_name" class="form-control modal-input" placeholder="Input Type" required />
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary modal-btn" name="typebtn" style="border-radius: 5px; padding: 10px 20px; background-color: #259E9E; border: none; box-shadow: none;">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm" action="code.php" method="POST">
                    ...
                    <button type="submit" name="delete_product_type" class="btn btn-danger" style="border-radius: 5px; padding: 10px 20px; background-color: #EB3223; border: none; box-shadow: none;">Delete</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="container-fluid">
    ...
    <button type="button" class="btn btn-primary rounded-pill shadow mb-3" data-toggle="modal" data-target="#addadminprofile" style="background-color: #259E9E; border: none; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
        <i class="fas fa-plus-square fa-lg"></i> <span style="font-weight: bold; text-transform: uppercase;">Add New Type</span>
    </button>
</h6>
...
<th style="vertical-align: middle;">Type Name</th>
